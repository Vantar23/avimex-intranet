...
export async function POST(req) {
    try {
        ...
        // Cambiar al directorio del repositorio y ejecutar los comandos
        exec('cd C:\\Usuarios\\Administrador\\source\\Nextjs\\nextjs-dashboard && git pull && pm2 restart nextjs-app', (error, stdout, stderr) => {
            if (error) {
                console.error(`Error al actualizar o reiniciar: ${error.message}`);
                return;
            }
